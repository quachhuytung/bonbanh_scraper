...
class ImportData:
    ...
    url varchar(256) not null, date timestamp, brand varchar(50),
    serie varchar(50),model_year varchar(10), info json, price_vnd int, 
    price_dol varchar(30), images json, description text,
    constraint url_unique unique(url));
    """

    insert_data = """
    insert into bonbanh (url, date, brand, serie, model_year, info, price_vnd, price_dol, images, description)
    values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s) on conflict on constraint url_unique do nothing;
    """
    def open_spider(self, spider):
